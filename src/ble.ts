        ...
        withExitStack(async (stack) => {
            ...
            const deviceResult = await maybe(
                navigator.bluetooth.requestDevice({
                    filters: [
                        { manufacturerData: [{ companyIdentifier: 1049 }] },
                    ],
                    optionalServices: [
            ...
            if (!serverResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error connecting to GATT server",
                );
            }
            ...
            if (!glassesInfoServiceResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting glasses info service",
                );
            }
            ...
            if (!classesInfoCharResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting glasses info characteristic",
                );
            }
            ...
            if (!deviceInfoServiceResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting device info service",
                );
            }
            ...
            if (!firmwareRevisionCharResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting firmware revision characteristic",
                );
            }
            ...
            if (!firmwareVersionResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting firmware version",
                );
            }
            ...
            if (!hardwareRevisionCharResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting hardware revision characteristic",
                );
            }
            ...
            if (!hardwareVersionResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting hardware version",
                );
            }
            ...
            if (!serialNumberCharResult.ok()) {
                ...
                return thunkAPI.rejectWithValue(
                    "Error getting serial number characteristic",
                );
            }
...
export const disconnectBle = createAsyncThunk(
    "ble/disconnect",
    async (arg: string) =>
        withExitStack(async () => {
